...
public class MkdirAction extends AbstractAction {
    ...
    private File resolveAndValidateDirectory() {
        ...
        if (file.exists()) {
            Preconditions.checkArgument(file.isDirectory(), "file '" + file.getAbsolutePath()
    ...
    public String toHuman() {
        return new DescriptionBuilder().forAction("mkdir").humanizedAs("create directory '%s'", directory)
