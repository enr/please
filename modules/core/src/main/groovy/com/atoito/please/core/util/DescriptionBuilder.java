...
public class DescriptionBuilder {
    ...
    public DescriptionBuilder withUsedFile(File file, String alias, List<File> outputs, boolean check) {
        ...
        if (file.exists()) {
            ...
            buffer.append(alias).append(" doesn't exist.").append(EOL).append(indent)
                    .append("configuration says to not check; maybe this file will be created from a former action");
        } else {
